...
Then briefly remind me of what's available: the tools `recall`, `save`, `list`, `supersede`, `contradictions`, `resolve`, and the `/know:recall`, `/know:contradictions`, `/know:resolve` commands.
